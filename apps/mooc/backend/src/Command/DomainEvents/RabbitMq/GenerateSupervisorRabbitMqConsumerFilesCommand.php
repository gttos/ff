...
final class GenerateSupervisorRabbitMqConsumerFilesCommand extends Command
{
    ...
    protected static                     $defaultName = 'gtto:domain-events:rabbitmq:generate-supervisor-files';
    ...
    {
        return <<<EOF
[program:gtto_{queue_name}]
command      = {path}/apps/mooc/backend/bin/console gtto:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
